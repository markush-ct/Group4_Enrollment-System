...
function FreshmenAdmissionRequest() {
  ...
  const handleApprove = async (request) => {
    ...
    if (!submissionDate && !examDatetime) {
      console.error("asdasd");
      setErrorPrompt(true);
      setErrorMsg("Set examination and submission date");
      return;
    }
  ...
  const handleReject = async (request) => {
    ...
    if (!rejectionReason) {
      console.error("Invalid request or Email missing:", request);
      setErrorPrompt(true);
      setErrorMsg("Input reason/s for rejecting admission request");
      return;
    }
        ...
        >
          <div className={styles.popupContent}>
            <div className={styles.popupHeader}>
              ...
              <h3>Send Reason for Admission Request Rejection</h3>
            </div>
