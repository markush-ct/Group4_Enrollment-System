    ...
    if (filterType === "All") {
      ...
      setFilteredRequests(
        accountRequests.filter(
          (request) => request.TransfereeCollegeCourse === filterType
        )
      );
    }
    ...
    <>
        ...
        >
          <div className={styles.popupContent}>
            <div className={styles.popupHeader}>
              ...
              <h3>Send Reason for Transfer Request Rejection</h3>
            </div>
      ...
      <div className={styles.contentSection}>
        ...
        <div className={styles.tableContainer} data-aos="fade-up">
          <table className={styles.requestsTable} data-testid="request-table">
            <thead>
              <tr>
                <th>Name</th>
                <th>Email</th>
                ...
                <div className={styles.infoGrid}>
                  <div className={styles.contentt}>
                    <p>
                      ...
                      <span>
                        {selectedRequest.ExamControlNo} 1st semester 2022-2023
                      </span>
                    </p>
                    <p>
