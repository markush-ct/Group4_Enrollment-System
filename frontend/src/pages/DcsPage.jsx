...
function DcsPage() {
    ...
    const Instructor = [
        ...
        'Benedick Sarmiento', 'Jerome Tacata', 'Russel Villareal, LPT', 'Redem Decipulo', 'Jen Jerome Dela Peña, LPT',
        'Roi Francisco', 'James Mañozo, LPT', 'Lorenzo Moreno Jr.', 'Jay-Ar Racadio', 'Alvina Ramallosa',
        'Niño Rodil', 'Ryan Paul Roy, LPT', 'Clarence Salvador', 'Cesar Talibong II'
      ];
    ...
    return (
        <>
            ...
            <div className={styles.mainPage}>
                ...
                {/* Regular Section */}
                <div data-aos="fade-up" className={styles.PageTitle}>DEPARTMENT OF COMPUTER STUDIES</div>
      ...
      <div className={styles.InstructorGrid}>
        {Instructor.map((Instructor, index) => (
          <span key={index} className={styles.InstructorName}>{Instructor}</span>
        ))}
      </div>
    </div></div>
