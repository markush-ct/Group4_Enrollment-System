...
describe("Unit Testing for Account Settings Component", () => {
  beforeAll(() => {
  ...
  test("Renders all labels with the correct text", () => {
    ...
    expect(screen.getByTestId("phone-label")).toHaveTextContent(
      "Phone Number:"
    );
    ...
    expect(screen.getByTestId("position-label")).toHaveTextContent("Job:");
  });
  ...
  test("Does not allow editing position in edit mode", () => {
    render(
      <Router>
        <AccountSettings />
      </Router>
