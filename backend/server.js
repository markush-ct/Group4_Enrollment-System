...
app.use(cors({
    ...
    methods: ['GET', 'POST', 'PUT', 'DELETE'], // Ensure OPTIONS is allowed
    credentials: true
}));
...
app.post('/editOldStudent', (req, res) => {
...
app.post('/editNewStudent', (req, res) => {
...
app.post('/editSocOfficerAccount', (req, res) => {
...
app.post('/editEmpAccount', (req, res) => {
